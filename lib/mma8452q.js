...
MMA8452Q.prototype._initAccel = function() {
  ...
  this.connection.i2cWrite(this.address, MMA8452Q.CTRL_REG1, 0xC7);

};

MMA8452Q.prototype._initTap = function() {


  this.connection.i2cWrite(this.address, MMA8452Q.PULSE_THSX, 0x3);

  this.connection.i2cWrite(this.address, MMA8452Q.PULSE_THSY, 0xC);

  this.connection.i2cWrite(this.address, MMA8452Q.PULSE_THSZ, 0x30);
