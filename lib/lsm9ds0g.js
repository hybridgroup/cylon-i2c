...
LSM9DS0G.prototype.getGyro = function(callback) {
  ...
  self.adaptor.i2cRead(self.address, OUT_X_L_G, 6, function(err, data) {
    if (err) {
      callback(err, null);
    } else {
      var result = {};
...
LSM9DS0G.prototype._initGyro = function() {
  ...
  this.adaptor.i2cWrite(this.address, CTRL_REG1_G, 0x0F); // Normal mode, enable all axes
  ...
  */
  this.adaptor.i2cWrite(this.address, CTRL_REG2_G, 0x00); // Normal mode, high cutoff frequency
  ...
  this.adaptor.i2cWrite(this.address, CTRL_REG3_G, 0x88); // Int1 enabled (pp, active low), data read on DRDY_G:
  ...
  SIM - SPI serial interface mode select
    0=4 wire, 1=3 wire */
  this.adaptor.i2cWrite(this.address, CTRL_REG4_G, 0x00); // Set scale to 245 dps
  ...
  this.adaptor.i2cWrite(this.address, CTRL_REG5_G, 0x00);
}
