...
BlinkM.prototype.goToRGB = function(r, g, b, cb) {
  this.adaptor.i2cWrite(this.address, TO_RGB, [r, g, b], cb);
};
...
BlinkM.prototype.fadeToRGB = function(r, g, b, cb) {
  this.adaptor.i2cWrite(this.address, FADE_TO_RGB, [r, g, b], cb);
};
...
BlinkM.prototype.fadeToHSB = function(h, s, b, cb) {
  this.adaptor.i2cWrite(this.address, FADE_TO_HSB, [h, s, b], cb);
};
...
BlinkM.prototype.fadeToRandomRGB = function(r, g, b, cb) {
  this.adaptor.i2cWrite(this.address, FADE_TO_RND_RGB, [r, g, b], cb);
};
...
BlinkM.prototype.fadeToRandomHSB = function(h, s, b, cb) {
  this.adaptor.i2cWrite(this.address, FADE_TO_RND_HSB, [h, s, b], cb);
};
...
BlinkM.prototype.playLightScript = function(id, repeats, startAtLine, cb) {
  this.adaptor.i2cWrite(this.address, PLAY_LIGHT_SCRIPT, [id, repeats, startAtLine], cb);
};
...
BlinkM.prototype.stopScript = function(cb) {
  this.adaptor.i2cWrite(this.address, STOP_SCRIPT, [], cb);
};
...
BlinkM.prototype.setFadeSpeed = function(speed, cb) {
  this.adaptor.i2cWrite(this.address, SET_FADE, [speed], cb);
};
...
BlinkM.prototype.setTimeAdjust = function(time, cb) {
  this.adaptor.i2cWrite(this.address, SET_TIME, [time], cb);
};
...
BlinkM.prototype.getRGBColor = function(cb) {
  return this.adaptor.i2cRead(this.address, GET_RGB, 3, cb);
};
...
BlinkM.prototype.getAddress = function(cb) {
  return this.adaptor.i2cRead(this.address, GET_ADDRESS, 1, cb);
};
...
BlinkM.prototype.setAddress = function(address, cb) {
  this.adaptor.i2cWrite(this.address, SET_ADDRESS, [address, 0xd0, 0x0d, address], cb);
...
BlinkM.prototype.getFirmware = function(cb) {
  return this.adaptor.i2cRead(this.address, GET_FIRMWARE, 1, cb);
};
