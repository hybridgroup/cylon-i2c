 ...
 */
var Jhd1313m1 = module.exports = function Jhd1313m1() {
  ...
  this._displayfunction = Jhd1313m1.FOURBITMODE | Jhd1313m1.TWOLINE | Jhd1313m1.FIVExEIGHTDOTS;
  this._displaycontrol = Jhd1313m1.DISPLAYON | Jhd1313m1.CURSOROFF | Jhd1313m1.BLINKOFF;
  this._displaymode = Jhd1313m1.ENTRYLEFT | Jhd1313m1.ENTRYSHIFTDECREMENT;

  this.setupCommands([
    "setRGB", "clear", "home", "setCursor", "scroll",
    "print", "setCustomChar"
  ]);
};
...
/**
 * Prints characters on the Jhd1313m1.
 *
 ...
 * @publish
 */
Jhd1313m1.prototype.print = function(str, callback) {
  var chars = str.split("");
...
Jhd1313m1.prototype._init = function() {
  ...
  this._sendCommand(Jhd1313m1.FUNCTIONSET | this._displayfunction);
  ...
  this._sendCommand(Jhd1313m1.ENTRYMODESET | this._displaymode);

  this._setReg(0, 0);
  this._setReg(1, 0);
  this._setReg(0x08, 0xAA);
};
...
Jhd1313m1.prototype._setReg = function(command, data) {
  this.connection.i2cWrite(this.address, command, data);
};
