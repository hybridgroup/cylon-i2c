    ...
    this.connection.i2cRead(
        ...
        function(err, data) {
            ...
            this.connection.i2cWrite(
                this.address, PCA9685_MODE1, newmode);
            this.connection.i2cWrite(
                this.address, PCA9685_PRESCALE, Math.floor(prescale));
            this.connection.i2cWrite(
                this.address, PCA9685_MODE1, [oldmode]);
            Cylon.Utils.sleep(100);
            this.connection.i2cWrite(
                this.address, PCA9685_MODE1, [oldmode | 0x80]);
        }.bind(this));
};
...
PCA9685.prototype.setPWM = function(channel, pulseon, pulseoff) {
    ...
    this.connection.i2cWrite(
        this.address, LED0_OFF_H + 4 * channel, [pulseoff >> 8]);
};
