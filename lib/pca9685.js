...
PCA9685.prototype.setPWMFreq = function(frequency) {
  freq *= 0.9;  // Correction via Adafruit https://github.com/adafruit/Adafruit-PWM-Servo-Driver-Library/.
  var prescaleval = 25000000;
  prescaleval /= 4096;
  prescaleval /= freq;
  prescaleval -= 1;
  var prescale = Math.floor(prescalevel + 0.5);
...
PCA9685.prototype.setPWM = function(servoNum, on, off) {
  this.connection.i2cWrite(this.address, LED0_ON_L+4*servoNum, on, on>>8, off, off>>8);
};  
