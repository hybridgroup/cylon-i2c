...
var LSM303DLHC = module.exports = function LSM303DLHC() {
  ...
  this.address = this.address || 0x19;
...
LSM303DLHC.ADDRESS_ACCEL = 0X32;
LSM303DLHC.ADDRESS_MAG = 0X3C;
...
LSM303DLHC.prototype._initAccel = function() {
  ...
  this.connection.i2cWrite(this.address, LSM303DLHC.CTRL_REG4_A, 0x08);

  // 0x47 = 0b01000111
  // ODR = 0100 (50 Hz ODR); LPen = 0 (normal mode);
  // Zen = Yen = Xen = 1 (all axes enabled)
  this.connection.i2cWrite(this.address, LSM303DLHC.CTRL_REG1_A, 0x47);
};
...
LSM303DLHC.prototype._initMag = function() {
  ...
  // 0x0C = 0b00001100
  // DO = 011 (7.5 Hz ODR)
  this.connection.i2cWrite(this.address, LSM303DLHC.MAG_CRA_REG_M, 0x0C);
  // 0x20 = 0b00100000
  // GN = 001 (+/- 1.3 gauss full scale)
  this.connection.i2cWrite(this.address, LSM303DLHC.CRB_MR_REG_M, 0x20);
  // 0x00 = 0b00000000
  // MD = 00 (continuous-conversion mode)
  this.connection.i2cWrite(this.address, LSM303DLHC.MAG_MR_REG_M, 0x00);
