...
var HMC5883L = module.exports = function HMC5883L() {
  ...
  this.address = this.address || 0x02;
...
HMC5883L.REG_OUT_Y_MSB = 0x05;
HMC5883L.REG_OUT_Y_LSB = 0x06;
HMC5883L.REG_OUT_Z_MSB = 0x07;
HMC5883L.REG_OUT_Z_LSB = 0x08;
...
HMC5883L.prototype._initMag = function() {
  ...
  this.connection.i2cWrite(this.address, HMC5883L.REG_STATUS, 0x3C);

    // temperature
    // this.connection.i2cWrite(this.address, HMC5883L.REG_DIE_TEMP, 0x0F);
