...
Mpu6050.prototype.start = function(callback) {
  // setClockSource
  this.adaptor.i2cWrite(this.address, MPU6050_RA_PWR_MGMT_1);
  this.adaptor.i2cWrite(this.address, MPU6050_PWR1_CLKSEL_BIT);
  this.adaptor.i2cWrite(this.address, MPU6050_PWR1_CLKSEL_LENGTH);
  this.adaptor.i2cWrite(this.address, MPU6050_CLOCK_PLL_XGYRO);

  // setFullScaleGyroRange
  this.adaptor.i2cWrite(this.address, MPU6050_GYRO_FS_250);
  this.adaptor.i2cWrite(this.address, MPU6050_RA_GYRO_CONFIG);
  this.adaptor.i2cWrite(this.address, MPU6050_GCONFIG_FS_SEL_LENGTH);
  this.adaptor.i2cWrite(this.address, MPU6050_GCONFIG_FS_SEL_BIT);

  // setFullScaleAccelRange
  this.adaptor.i2cWrite(this.address, MPU6050_RA_ACCEL_CONFIG);
  this.adaptor.i2cWrite(this.address, MPU6050_ACONFIG_AFS_SEL_BIT);
  this.adaptor.i2cWrite(this.address, MPU6050_ACONFIG_AFS_SEL_LENGTH);
  this.adaptor.i2cWrite(this.address, MPU6050_ACCEL_FS_2);

  // setSleepEnabled
  this.adaptor.i2cWrite(this.address, MPU6050_RA_PWR_MGMT_1);
  this.adaptor.i2cWrite(this.address, MPU6050_PWR1_SLEEP_BIT);
  this.adaptor.i2cWrite(this.address, 0);
...
Mpu6050.prototype.getMotionAndTemp = function(callback) {
  this.adaptor.i2cRead(this.address, MPU6050_RA_ACCEL_XOUT_H, 14, function(err, d) {
