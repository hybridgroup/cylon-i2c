/*
 * MMA7660 I2C accelerometer driver
 * http://cylonjs.com
 *
...
var MMA7660 = module.exports = function MMA7660() {
  MMA7660.__super__.constructor.apply(this, arguments);
...
Cylon.Utils.subclass(MMA7660, I2CDriver);
...
MMA7660.MMA7660_SR = 0x08;	   // sample rate register
MMA7660.AUTO_SLEEP_120 = 0X00; // 120 sample per second
...
MMA7660.prototype.start = function(callback) {
  this._initAccel();
  callback();
};
...
MMA7660.prototype.getAccel = function(callback) {
  var self = this;
...
MMA7660.prototype._initAccel = function() {

  // set the mode to standby must be in stanby to set sample rate
  this.connection.i2cWrite(this.address, MMA7660.MMA7660_MODE, 0x00);
  // set the sample rate
  this.connection.i2cWrite(this.address, MMA7660.MMA7660_SR, 0X02);
  // set the mode to active
  this.connection.i2cWrite(this.address, MMA7660.MMA7660_MODE, 0x01);
