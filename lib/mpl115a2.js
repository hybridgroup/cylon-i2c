...
Mpl115A2.prototype.readCoefficients = function(callback) {
  ...
  this.adaptor.i2cRead(this.address, MPL115A2_REGISTER_A0_COEFF_MSB, 8, function(err, d) {
...
Mpl115A2.prototype.getPT = function(callback) {
  ...
  this.adaptor.i2cWrite(this.address, MPL115A2_REGISTER_STARTCONVERSION);
  this.adaptor.i2cWrite(this.address, 0x00);

  Cylon.Utils.sleep(5);

  this.adaptor.i2cRead(this.address, MPL115A2_REGISTER_PRESSURE_MSB, 4, function(err, d) {
